...
> 这里所说的清除浮动，指的是清除浮动与浮动之间的影响。浮动元素会影响兄弟元素（下面的例子  ）和父元素的布局（高度塌陷）

### 前言

<img src="07-%E6%B5%AE%E5%8A%A8.assets/image-20210323162611730.png" alt="image-20210323162611730" style="zoom:33%;" />
